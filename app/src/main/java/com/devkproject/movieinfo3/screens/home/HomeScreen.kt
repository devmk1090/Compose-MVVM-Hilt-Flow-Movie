...
import com.devkproject.movieinfo3.screens.BannerAdView
import com.devkproject.movieinfo3.screens.components.CommonAppBar
import com.devkproject.movieinfo3.screens.drawer.NavigationDrawer
import com.devkproject.movieinfo3.ui.theme.primaryGray
        ...
        Scaffold(
            ...
            if (currentScreen == NavigationObject.HOME) {
                LazyColumn {
                    ...
                    item {
                        HomeScreenMovieType(navController = navController, pagingItems = topRatedMovieList, title = "평점순", type = "TopRated")
...
//                    }
                ...
                LazyColumn {
                    ...
                    item {
                        HomeScreenTvType(navController = navController, pagingItems = topRatedTvList, title = "평점순", type = "TopRated")
                        Spacer(modifier = Modifier.height(50.dp))
                    }
//                    item {
